    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SongID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    AuthorInTitle = table.Column<bool>(nullable: false),
                    DisplayTitle = table.Column<string>(nullable: true),
                    Info = table.Column<string>(nullable: true),
                    TextLanguage = table.Column<int>(nullable: false),
                    Title = table.Column<string>(nullable: false),
                    WithBacking = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BackingID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    BackingStatus = table.Column<int>(nullable: false),
                    MainBacking = table.Column<bool>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Backings", x => x.BackingID);
                    table.ForeignKey(
                        name: "FK_Backings_Songs_SongID",
                        column: x => x.SongID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SongID = table.Column<int>(nullable: false),
                    AuthorID = table.Column<int>(nullable: false),
                    MainSongAuthor = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
