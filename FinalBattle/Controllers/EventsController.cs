...
namespace FinalBattle.Controllers
{
    ...
    public class EventsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Events.Include(p => p.Place).Include(u => u.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var @event = await _context.Events
                .Include(p => p.Place).Include(u => u.User)
        ...
        {
            ViewData["PlaceID"] = new SelectList(_context.Places, "PlaceID", "Address");
        ...
        public async Task<IActionResult> Create([Bind("EventID,Title,Date,DateEnd,PlaceID,Info,EventType,UserID")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,Title,Date,DateEnd,PlaceID,Info,EventType,UserID")] Event @event)
        {
            if (id != @event.EventID)
            {
                return NotFound();
